...
name = input("Username:")
def exc(a):
    Excersize_name = input("Which Excersize You Complete mr Paolo ==>>")
    date = getdate()
    f = open(a, "a")
    f.write("\n")
    f.write("[")
...
work=1
while (work <= 50):
 print("Welcome to HEALTH & GYM MANAGEMENT SYSTEM  ")
...
#Excersize Data
 ...
 if(user_input1 == 1):
           ...
           print("1-retrive or 11-Show For Paolo")
           print("2-retrive or 22-Show for John")
           print("3-retrive or 33-Show for Kyle")
           print("4 for Others\n")
           a1 = "he.txt"
           a2 = "ve.txt"
           a3 = "se.txt"
